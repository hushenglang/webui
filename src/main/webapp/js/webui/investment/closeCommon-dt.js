...
//		}
	 ...
	 * @param  param         窗口相关参数
	 */
	showCloseWindowDiv : function(param){
		var baseSetting = {
			closeOnEscape: false,
			autoOpen: false,
			resizable: false,
		...
		this._$closePostWindowDiv.dialog(result);
	},	
	...
	openClosePostWindowDiv : function(p){
		...
		this._$closePostWindowDiv.dialog("open");
			...
			alert('close common line 93, error:' +e);
		}
	},
...
$(function() {
	...
	CloseCommon._create();
	CloseCommon.showCloseWindowDiv();
});
