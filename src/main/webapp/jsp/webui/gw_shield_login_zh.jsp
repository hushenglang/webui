...
贵金属交易涉及相当大的风险，其并非对每个投资者都适合。请参照风险披露声明和本协议，了解有关风险的详细资料。虽然网上交易爲客户带来很多方便或更有效率，但它并不降低贵金属交易本身的风险。因此客户在交易前，须准备承担此风险。</li>
...
倘若报价或成交价出现错误时，金道贵金属对于账户结馀相应错误并不负责。有关错误可能包括但不限于：交易员的错误报价，非国际市场价之报价、或是任何报价错误（例如由于硬件、软件或者通讯线路或系统故障导致报价错误或者第三者提供了错误的外部数据数据）。金道贵金属不需爲错误所导致的账户余额负责，客户下单时需预留足够的时间执行订单和系统计算所需保证金的时间。若订单的执行价格或订单设定和市场价格过于接近，这可能会触发其他订单（所有订单类型）或发出保证金提示。金道贵金属不会对由于系统没有足够时间执行订单或进行运算所产生的保证金提示、账户结馀或账户头寸负责。上文不得视作内容尽列，一旦发生报价或执行错误，金道贵金属保留对有关账户进行必要更正或调整的权利。对于报价或执行错误而産生的任何争议，我们将依据绝对酌情权进行解决。若因此带来任何损失、损害或责任，客户同意予以赔偿使金道贵金属不受损害。</li>
        <li><strong>v. 套等</strong><br />
互联网、联机延误及报价上的误差有时会造成在金道贵金属交易平台上的报价无法准确地反映实时市场价格。 「套等」及「切彙」，或因网络连接的延误而利用差价获利的行爲，并不能存在于客户直接向庄家进行买卖的场外交易市场​​中。金道贵金属不容许客户在本公司的交易平台上进行此等套等行为。依据因价格滞后带来的套等机会进行的交易有可能会被撤销。金道贵金属保留权利对涉及上述交易的账户进行必要的修正和调整。金道贵金属可依据绝对酌情权，要求交易员进行干预或核准所有下单以及或终止有关客户的账户，而不需事先通知客户。对套戥及/或操控价格而産生的纠纷，金道贵金属将依据绝对酌情权进行解决。金道贵金属保留冻结客户提款的权利直至能够完全解决上述的问题爲止。于此陈述的任何行动或决议将不会损害或放弃令金道贵金属对客户和其僱员拥有之任何权力或赔偿。</li>
        <li class="li-bg"><strong>vi. 操控价格、执行及平台</strong><br />
金道贵金属绝对严禁以任何形式对其价格、执行及平台进行操控。若金道贵金属怀疑任何账户从事操控，金道贵金属保留对账户进行调查及审核等的相关权利，并从涉嫌账户中扣除由相关活动所赚取的盈利款项。金道贵金属保留对相关账户进行必要更正或调整的权利。对于涉嫌从事操控的账户，金道贵金属依据绝对酌情权，要求交易员进行干预、对下单进行核准以及或终止有关客户的账户。对于由套戥及或操控所産生的任何纠纷，金道贵金属将依据绝对酌情权进行解决。金道贵金属可依据酌情权决定向任何相关监管机构或执法机构报告有关事件。于此处所陈述的任何行动或决议并不免除或损害金道贵金属对客户和其雇员拥有之任何权利或赔偿。</li>
      </ul>
    </div>
  </div>
</div>
...
<div class="headbg">
	<div id="header" class="clearfix">
	  <h1 class="logo fl"><a href="http://www.24k.hk" class="hide-t" title="金道贵金属">GT1-客户登入</a></h1>
	  <!-- <p class="r-menu fr"><a href="#nogo">繁体</a>|<a href="../zh/login.html" class="c-on">简体</a></p> -->
	</div>
</div>
    ...
    <div class="login-box login-box-jdd">
       <form id="gwshieldform" action="GWShieldLogin.action" method="post">
	      <dl class="login_all_dl clearfix">
	        <dt>请输入金道盾动态密码：</dt><dd class="login_all_d1"><input type="text" value="" name="gw_shield_code" id="gw_shield_code" class="inp_a1 fd"></dd>
	        <dd class="login_all_d2">(可于金道盾终端获取，注意动态密码每分锺更新一次)</dd>
	        
	        <dd class="login_all_d3">
	        	<a id="submit_btn" href="#" onclick="javascript:submitForm()">确认</a><a href="<%=request.getContextPath()%>">退出</a>
	        </dd>
	        
	        <dd id="errormsg_loginfail" style="display:none" class="tishi-info">动态密码错误，请确认后重新输入！</dd>
	        <dd id="errormsg_lock" style="display:none" class="tishi-info">金道盾动态密码验证功能已锁定，若需解锁请联系客服！</dd>
	        <dd id="errormsg_dynamic_code_used" style="display:none" class="tishi-info">阁下输入的动态密码已使用，请输入更新后的动态密码！</dd>
	        <dd id="errormsg_5timelock" style="display:none" class="tishi-info">阁下输入的动态密码连续校验5次没有通过，<span id="countdownSpan">5</span> 秒后将自动退出。若有疑问请联系在线客服！</dd>
      	</dl>
