		...
		<ul class="quote_item clearfix">
			...
			<li id="li_llg">
	            <div id="close_div_llg" class="stop_div" style="display:none">
	            	<div class="closed_txt">已關閉</div>
	            </div>
	            <div id="timer_div_llg" class="stop_div" style="display:none">
	            	<div class="open_time">距離開市<br><span id="timer_time_llg" class="time">00:19:54</span></div>
	            </div>
				
				<div class="quote_top">
					<a href="javascript://" class="qt_icon1" title="產品屬性" id="btn_gold_productAttribute">產品屬性</a>
					<a href="javascript://" class="qt_icon2" title="價格明細" id="btn_gold_tickPriceList">價格明細</a>
					<strong class="name">倫敦金</strong>
				...
				<div class="quote_price_box">
					...
					<div class="quote_sell" onclick="QuotationGTS.callModifyFun('022', 1);">
						<strong class="name">賣出</strong> <span class="price" id="box_022_bid">---</span>
					</div>
					<div class="quote_buy" onclick="QuotationGTS.callModifyFun('022', 0);">
						<strong class="name">買入</strong> <span class="price" id="box_022_ask">---</span>
					</div>
				</div>
			</li>
			...
			<li id="li_lls">
	            ...
	            <div id="timer_div_lls" class="stop_div" style="display:none">
	            	<div class="open_time">距離開市<br><span id="timer_time_lls" class="time">00:19:54</span></div>
	            </div>
			
				<div class="quote_top">
					<a href="javascript://" class="qt_icon1" title="產品屬性" id="btn_silver_productAttribute">產品屬性</a>
					<a href="javascript://" class="qt_icon2" title="價格明細" id="btn_silver_tickPriceList">價格明細</a>
					<strong class="name">倫敦銀</strong>
				...
				<div class="quote_price_box">
					...
					<div class="quote_sell" onclick="QuotationGTS.callModifyFun('023', 1);">
						<strong class="name">賣出</strong> <span class="price" id="box_023_bid">---</span>
					</div>
					<div class="quote_buy" onclick="QuotationGTS.callModifyFun('023', 0);">
						<strong class="name">買入</strong> <span class="price" id="box_023_ask">---</span>
					</div>
				</div>
			</li>
			...
			<li id="li_usdinx" class="stop_business">
				...
				<div class="quote_price_box">
					...
					<div class="quote_sell" onclick="javascript:Alert('參考行情，不提供交易服務。')">
						<strong class="name">賣出</strong> <span class="price" id="box_050_bid">---</span>
					</div>
					<div class="quote_buy" onclick="javascript:Alert('參考行情，不提供交易服務。')">
						<strong class="name">買入</strong> <span class="price" id="box_050_ask">---</span>
					</div>
				</div>
			</li>
			...
			<li id="li_oil" class="stop_business">
				...
				<div class="quote_price_box">
					...
					<div class="quote_sell" onclick="javascript:Alert('參考行情，不提供交易服務。')">
						<strong class="name">賣出</strong> <span class="price" id="box_00E_bid">---</span>
					</div>
					<div class="quote_buy" onclick="javascript:Alert('參考行情，不提供交易服務。')">
						<strong class="name">買入</strong> <span class="price" id="box_00E_ask">---</span>
					</div>
				</div>
			</li>
