		...
		<div class="navbox clearfix">
			...
			<div class="navbox-c fl">
				<div class="nav-qh clearfix">
					...
					<ul class="fl">
						<li class="on-na">圖表</li>
					</ul>
					<ul class="hu">
				       			<li><span class="huLabel">時間: </span><span id="huTime" class="huField" style="color: #DDBBBB;"></span></li>
								<li><span class="huLabel">開市: </span><span id="huOpen" class="huField" style="color: #DDBBBB;"></span></li>
