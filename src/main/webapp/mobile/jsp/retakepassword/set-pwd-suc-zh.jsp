    ...
    <div class="user-dengl">
      <div class="login-box">
        ...
        <div class="form-box" id="trueTrade">
          <h2>重设密码</h2>
          <h3>您已成功重设密码</h3>
          <p class="log-set-info log-set-pad">新密码将发送到您的登记电邮地址。<br />为保障您的账户安全，请收到新密码后，自行更改密码。<br />如有任何查询，请联络<a href="#">在线客服</a></p>
        </div>      
        <!-- 真实交易end --> 
        </div>
        <p class="login-pwd-btn"><a href="Login.action?lang=zh_CN">客户登录</a></p>
      </div>
    </div>  
  <!-- login end -->
</div>
