       ...
       <form id="gwshieldform" action="GWShieldLogin.action" method="post">
	        <div class="form-box" id="trueTrade">
	          ...
	          <div class="form-listbox">
	            <div id="errormsg_loginfail" style="display:none" class="tishi-info red">動態密碼錯誤，請確認後重新輸入！</div>
		        <div id="errormsg_lock" style="display:none" class="tishi-info red">金道盾動態密碼驗證功能已鎖定，若需解鎖請聯系客服！</div>
		        <div id="errormsg_dynamic_code_used" style="display:none" class="tishi-info red">閣下輸入的動態密碼已使用，請輸入更新後的動態密碼！</div>
		        <div id="errormsg_5timelock" style="display:none" class="tishi-info red">閣下輸入的動態密碼連續校驗5次沒有通過，<span id="countdownSpan">5</span> 秒後將自動退出。若有疑問請聯系在線客服！</div>
	          </div>
	        </div>  
