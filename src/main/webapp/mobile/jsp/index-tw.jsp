...
<link href="<%=path%>/mobile/css/index.css?v=<%=LoginAction.getLastVersion().getVersion()%>" rel="stylesheet" type="text/css">
...
<script type="text/javascript" src="<%=request.getContextPath()%>/js/js_i18n/common_mb_tw.js"></script>
...
<p style="padding-top:5px">正在載入頁面，請稍候 ...</p>
</div>
<div id="body" style="display:none">

	  <!-- 交易彈出框 -->
	<%@include file="../jsp/trade/trade-tw.jsp" %>
	 <!-- 修改委託單彈出框 -->
	<%@include file="../jsp/trade/modifyTrade-tw.jsp"%>
	
<div id="wrapper">
  <!-- header begin -->
  <div id="header">
    <div class="logo"><a href="javascript:" class="hide-t">金道貴金屬</a></div>
  </div>
  <!-- header end -->
  ...
  <div class="center-box">   
        ...
        <div class="rbox-wrap2 clearfix" id="index_investment_div">                              
          <div class="navbox clearfix">
            <div class="navbox-l fl"></div>
            <div class="navbox-c fl">
              <div class="nav-qh">
                <ul class="fl" id="investment-entrust-fl">
						<li class="on-na" tn="accountPositionsTable">持倉部位</li>
						<li tn="closedPositionTable">已平倉部位</li>
						<li tn="pendingOrderTables">當日委託</li>
						<li tn="accountSummaryTable">賬戶總結</li>
						<li tn="dynamicUpdatesTable">實時動態</li>
				</ul>
              </div>
            </div>
          </div>
          ...
          <div class="tubiao-data weitu-data" id="investment-entrust-cont">
           <div>
            ...
            <!--已平倉部位begin-->
            <div class="touz-tabox" id="closedPosition">
            </div>
            <!--已平倉部位end-->

            <!-- 當日委託begin -->
            <div class="touz-tabox" id="pendingOrders">
            </div>
            <!-- 當日委託end -->
...
<div id="index_tab_div" style="display:none">
  <div class="top-menubox clearfix">
   ...
   <!-- 新闻列表 -->   
   <%@include file="../jsp/news/news-tw.jsp" %>
   <!-- 公告弹出框列表 -->
   <%@include file="../jsp/bulletin/bulletin-tw.jsp" %>
   <!-- 报表弹出框 -->
  <%@include file="../jsp/report/report-tw.jsp" %>
   <!-- 图表模块 -->
  <%@include file="../jsp/chart/chart-tw.jsp" %>
</div>
...
<div id="footer" class="clearfix">
  <div class="menu-box-con fl clearfix">
    <ul>
      <li class="m-icon0"><a href="javascript://" id="btn_menu_index_home" tn="wrapper"><i></i>主頁</a></li>
      <li class="m-icon1"><a href="javascript://" id="btn_menu_chart" tn="index_chart_div"><i></i>圖表</a></li>
      <li class="m-icon2"><a href="javascript://" id="btn_menu_report_01" tn="index_report_container"><i></i>報表</a></li>
      <li class="m-icon3"><a href="javascript://" id="btn_menu_investment" tn="index_investment_div"><i></i>倉位</a></li>
      <li class="m-icon4"><a href="javascript:" id="btn_menu_bulletin_01" tn="index_leftGg"><i></i>公告</a></li>
      <li class="m-icon5"><a href="javascript:" id="btn_menu_new_01" tn="index_leftNewsDiv"><i></i>新聞</a></li>
      <% if(session.getAttribute("usernamedemo")==null){ %>
      <li class="m-icon6"><a onclick="gotoGoldAdmin('deposit')"><i></i>存取款</a></li>
      <%}else{ %>
      <li class="m-icon6"><a href="https://goldadmin.24k.hk/goldadmin/changeDemoMobileTradePwd.do" target="_blank"><i></i>修改密碼</a></li>
      <%} %>
      <li class="m-icon7"><a href="http://www.24k.hk/tw/finance/index.html" target="_blank"><i></i>財經日歷</a></li>
      <li class="m-icon8"><a href="http://m.24k.hk/tw/subjectlist.html" target="_blank"><i></i>優惠活動</a></li>
      <li class="m-icon9"><a href="javascript:" id="btn_menu_qq_01"><i></i>QQ客服</a></li>
      <li class="m-icon10"><a href="javascript:" id="btn_menu_online_01"><i></i>在線客服</a></li>
      <li class="m-icon11"><a href="javascript:" id="btn_menu_language_01" tn="zh_CN"><i></i>简体</a></li>
      <li class="m-icon12"><a href="javascript:" id="btn_menu_full_ver_01"><i></i>桌面版</a></li>
      <li class="m-icon13" style="display:none"><a href="javascript:" id="btn_menu_style_change_01" tn="day"><i></i>夜間</a></li>
      <li class="m-icon16"><a href="http://www.24k.hk/common/GTS_web_trading_guide.pdf" target="_blank"><i></i>平臺指南</a></li>
      <li class="m-icon14"><a href="javascript:" id="btn_menu_logout_btn_01"><i></i>登出</a></li>
      <li class="m-icon15 dn" id="menu-layer"><a href="javascript://"><i></i>菜單</a></li>
    </ul>
  </div>
  <!-- 彈出層begin -->
  <div class="menu-tan-box dn">
    ...
    <ul class="menu-box-con menu-cent-box">
      ...
      <li class="m-icon5"><a href="javascript:" id="btn_menu_new_02" tn="index_leftNewsDiv"><i></i>新聞</a></li>
      <% if(session.getAttribute("usernamedemo")==null){ %>
      <li class="m-icon6"><a onclick="gotoGoldAdmin('deposit')"><i></i>存取款</a></li>
      <%}else{ %>
      <li class="m-icon6"><a href="https://goldadmin.24k.hk/goldadmin/changeDemoMobileTradePwd.do" target="_blank"><i></i>修改密碼</a></li>
      <%} %>
      <li class="m-icon7"><a href="http://www.24k.hk/tw/finance/index.html" target="_blank"><i></i>財經日歷</a></li>
      <li class="m-icon8"><a href="http://m.24k.hk/zh/subjectlist.html" target="_blank"><i></i>優惠活動</a></li>
      <li class="m-icon9"><a href="javascript:" id="btn_menu_qq_02"><i></i>QQ客服</a></li>
      <li class="m-icon10"><a href="javascript:" id="btn_menu_online_02"><i></i>在線客服</a></li>
      <li class="m-icon11"><a href="javascript:" id="btn_menu_language_02" tn="zh_CN"><i></i>简体</a></li>
      <li class="m-icon12"><a href="javascript:" id="btn_menu_full_ver_02"><i></i>桌面版</a></li>
      <li class="m-icon13" style="display:none"><a href="javascript:" id="btn_menu_style_change_02" tn="day"><i></i>夜間</a></li>
      <li class="m-icon16"><a href="http://www.24k.hk/common/GTS_web_trading_guide.pdf" target="_blank"><i></i>平臺指南</a></li>
  ...
  <div class="ftinfo fl">
	    ...
	    <div class="ftinfo-c bobao-atbox fl">
	      <p class="bobao-info fl">倫敦金：<span id="symbol022Price">---</span><span id="symbol022PriceChange">---</span></p>
	      <p class="bobao-info fr">倫敦銀：<span id="symbol023Price">---</span><span id="symbol023PriceChange">---</span></p>
	    </div>
	...
	<div id="marginLevelWarning" class="mess-layer clearfix" >
	  <span class="mess-title fl">提示：維持保證金不足，請及時補足資金</span>
	  <p class="mess-btn fr"> <a id="marginLevelWarningConfirm" href="javascript:">確認</a></p>
	</div>
	<!--消息提示end-->
		<!-- <div class="ftinfo fl">
			<div class="ftinfo-l fl"></div>
		...
		<div class="frtimt frtimt-red fr" id="index_connect_tip">
			<div class="frt-stadus">服務器連接已斷開<i></i></div>
			<span id="sp_conn_status">連接狀態：連接中</span>
			<span>&nbsp;行情資訊由金道貴金屬公司提供</span>
			繫統時間：
	  ...
	  <div class="layer-con layer-con-weit">
	    ...
	    <div class="lay-kuang-fon">
	      <div class="lay-kuang-con">
	        <p class="wxts-pinfo" id="cancelorder_confirm_tips">您確定要取消該筆委托單嗎？</p>
	...
	<div class="layer-box dn" id="div_logout_confirm">
	  <div class="layer-con layer-con-weit">
	    ...
	    <div class="lay-kuang-fon">
	      <div class="lay-kuang-con">
	        <p class="wxts-pinfo">您確定要登出這個賬戶嗎？</p>
